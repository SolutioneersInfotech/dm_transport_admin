...
export default function Drivers() {
  ...
  const isSearchSupplementing = Boolean(debouncedSearch.trim()) && isFetching;
      ...
      >
        <div className="flex h-full min-h-0 flex-1 flex-col rounded-m border border-slate-800 bg-slate-950/60">
          ...
          >
            ...
            {isSearchSupplementing && !isInitialLoading && (
              <div className="flex items-center gap-2 px-4 py-3 text-xs text-sky-300">
                <span
