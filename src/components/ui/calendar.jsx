  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_end:
          "day-range-end aria-selected:bg-[#1f6feb] aria-selected:text-white",
        day_range_start:
          "day-range-start aria-selected:bg-[#1f6feb] aria-selected:text-white",
        day_selected:
        ...
        day_range_middle:
          "aria-selected:bg-[#1f6feb]/20 aria-selected:text-white",
