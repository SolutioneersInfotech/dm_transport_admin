...
export default function DateRangePicker({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        className={[
          "inline-flex w-fit items-center whitespace-nowrap bg-[#1d232a] border border-gray-700 rounded-md px-4 py-2 text-left text-gray-300 transition-colors hover:bg-[#20262e] hover:border-gray-600",
          triggerClassName,
        ]
          .filter(Boolean)
          .join(" ")}
